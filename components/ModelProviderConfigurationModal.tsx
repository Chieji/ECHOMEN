    ...
    return (
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    <motion.div
                        className="w-full max-w-lg bg-white/90 dark:bg-[#141414]/90 backdrop-blur-lg border-2 border-cyan-600/50 dark:border-echo-cyan/50 rounded-xl shadow-2xl shadow-black/50 flex flex-col max-h-[90vh]"
