                ...
                >
                    ...
                    >
                        ...
                        <div className="flex-grow overflow-y-auto p-6 space-y-4">
                            <div>
                                <label htmlFor="agentName" className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Agent Name</label>
                                <input
                                    type="text"
                                    id="agentName"
                                    value={name}
                            ...
                            <div>
                                ...
                                <div className="flex gap-4">
                                    <div className="w-2/3">
                                        <div className="grid grid-cols-5 gap-2 mb-2 bg-black/5 dark:bg-black/40 p-2 rounded-lg border border-black/10 dark:border-white/10">
                                            {Object.keys(PREDEFINED_ICONS).map(iconName => (
                                                <button 
                                                    key={iconName}
                                                    onClick={() => setIcon(iconName)}
                                                    className={`p-2 rounded-lg transition-colors ${icon === iconName ? 'bg-cyan-600/20 ring-2 ring-cyan-600 dark:bg-[#00D4FF]/30 dark:ring-[#00D4FF]' : 'bg-black/5 dark:bg-black/40 hover:bg-black/80'}`}
                                                >
                                                    <AgentIcon icon={iconName} className="w-6 h-6 mx-auto text-gray-400 dark:text-gray-300" />
                                                </button>
                                            ))}
                                        </div>
                                        <input
                                    ...
                                    <div className="w-1/3 flex flex-col items-center justify-center bg-black/5 dark:bg-black/40 rounded-lg p-2 border border-black/10 dark:border-white/10">
                                         <span className="text-sm text-gray-500 dark:text-gray-400 mb-2">Preview</span>
                             ...
                             <div>
                                <label htmlFor="agentDescription" className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Agent Description</label>
                                <textarea
                                    id="agentDescription"
                                    value={description}
                            ...
                            <div>
                                <label htmlFor="agentInstructions" className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Agent Instructions</label>
                                <textarea
